package org.example.triptally.travel.model;
...
public class Trip {
    ...
    // Keep your names; map them to the amount columns
    @Column(name = "budget_home", nullable = false, precision = 12, scale = 2)
    private BigDecimal budgetHomeCurrency;

    @Column(name = "budget_local", nullable = false, precision = 14, scale = 2)
    private BigDecimal budgetLocalCurrency;

    @Column(name = "home_currency_code", length = 3, nullable = false)
    private String homeCurrencyCode;

    @Column(name = "local_currency_code", length = 3, nullable = false)
